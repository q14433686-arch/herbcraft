...
- herbcraft-alchemy-1.1.1.jar
  Optional alchemy module. Requires herbcraft.

- herbcraft-cuisine-1.1.1.jar
  Optional cuisine module. Requires herbcraft.

Install:
1. Install Fabric Loader and Fabric API.
2. Put herbcraft-1.1.1.jar into your mods folder.
3. Optionally add herbcraft-alchemy-1.1.1.jar and/or herbcraft-cuisine-1.1.1.jar.
